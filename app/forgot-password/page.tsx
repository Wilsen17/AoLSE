...
export default function ForgotPasswordPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setMessage(
          "Password sementara telah dikirim ke email Anda. Silakan cek email dan login dengan password sementara tersebut.",
        )
      } else {
          ...
          <div className="w-full max-w-md">
            <div className="bg-[#f8f3e2] rounded-3xl p-8 shadow-lg">
              ...
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-[#4a5c2f]">Lupa Password</h2>
                <p className="text-[#4a5c2f] mt-2">Masukkan email Anda untuk mendapatkan password sementara</p>
              </div>

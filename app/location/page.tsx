        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <div className="mb-8 flex justify-center">
            <div className="relative w-full max-w-md">
              <Input
                type="text"
                placeholder="Temukan Lokasi Terdekat....."
                value={searchQuery}
                onChange={(e) => setSearchQuery(e.target.value)}
                className="w-full pl-4 pr-12 py-3 text-lg border-2 border-[#7a8c4f] rounded-lg focus:outline-none focus:border-[#5a6c3f] bg-white"
              />
              <div className="absolute right-3 top-1/2 transform -translate-y-1/2">
                <Search className="w-6 h-6 text-[#7a8c4f]" />
              </div>
            </div>
          </div>
          ...
          <div className="bg-[#7a8c4f] rounded-3xl p-8 shadow-lg">
            {filteredLocations.length === 0 ? (
              <div className="text-center py-8">
                <p className="text-white text-xl">Tidak ada lokasi yang ditemukan untuk "{searchQuery}"</p>
              </div>
            ) : (
